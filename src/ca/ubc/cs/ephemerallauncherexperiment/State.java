...
public class State {
	...
	public static String stateCsvLog(Context context){
		return Utils.appendWithComma(participantId, String.valueOf(block), condition.toString(), String.valueOf(trial), String.valueOf(page), String.valueOf(startTime), String.valueOf(targetIconPage), String.valueOf(targetIconRow), String.valueOf(targetIconColumn), Utils.extractIconName(context.getString(Distributions.targets[trial]),ExperimentParameters.ICON_RESOURCE_ADDRESS_PREFIX), context.getString(Distributions.targets[trial]));
	}
